"""Fork recent top-opponent states into V106 and adaptive submitted-policy continuations."""
...
def main() -> None:
    ...
    replay_dir = ROOT / "data/replays/v106_recent_adaptive_replay_forks"
    games = []
    ...
    result = {
        ...
        "format": "kaggriculture-v106-adaptive-replay-forks-v1",
        ...
        "purpose": "adaptive path/resource diagnostic; not top-policy counterfactual or rating estimate",
        "summary": summary,
        "paired_diagnostics": paired,
        "games": games,
    }
    output = ROOT / "data/runs/v106_recent_adaptive_replay_forks.json"
