"""Round8 execution contracts for the frozen Round7 learned checkpoints.
...
def _decode_actor(
    ...
    *,
    ...
    legal = _contract_legal_tokens(observation, index, reserved, full_contract=full_contract)
