"""V114r1: V114 with the route checkpoint's configuration argument corrected."""
...
_spec = importlib.util.spec_from_file_location("_v114r1_v111", SOURCE)
...
def policy_diagnostics(obs):
    return {**base.policy_diagnostics(obs), "version": "v114r1", "research_decision": _state(obs)["decision"]}
