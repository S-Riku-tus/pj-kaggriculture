"""Kaggriculture V113: externally validated continuation and order priority.
...
ENABLE_GENERALIZED_ANIMAL_GATE = False
...
def _prime_generalized_goal(obs: Any, state: dict[str, Any]) -> None:
    ...
    goal = {
        "step": 216,
        "reason": "v113-external-top3-validated-animal-tilt",
        "animal_tilt": tilt,
        "max_abs_z": max_z,
        "animal_residual_score": residual,
    }
...
def policy_diagnostics(obs: Any) -> dict[str, Any]:
    ...
    return {
        **base.policy_diagnostics(normalized),
        "version": "v113",
        "strategic_policy": "v111-plus-external-top3-validated-animal-gate",
